...
var HomePage = (function () {
    function HomePage(navCtrl, authService, events, formBuilder, network, zone, plt, socialSharing, helper) {
        ...
        this.authService.postData(data, 'userExists.php').then(function (result) {
            ...
            if (_this.responseUserData[0]) {
                _this.myPoints = _this.responseUserData[0].puntos != null ? _this.responseUserData[0].puntos : '0';
                _this.scoresRight = _this.responseUserData[0].marcadoresAcertados != null ? _this.responseUserData[0].marcadoresAcertados : '0';
                _this.tieGames = _this.responseUserData[0].empates != null ? _this.responseUserData[0].empates : '0';
                _this.winTeams = _this.responseUserData[0].equiposGanadores != null ? _this.responseUserData[0].equiposGanadores : '0';
                _this.passedTeams = _this.responseUserData[0].equiposClasificados != null ? _this.responseUserData[0].equiposClasificados : '0';
            }
        });
...
var GroupsPage = (function () {
    function GroupsPage(navCtrl, authService, navParams, helper, modalCtrl, events, loadingCtrl, network, zone) {
        ...
        this.events.subscribe('reloadGroups', function (_type) {
            //call methods to refresh content
            _this.displayGroupsAndTeams(_type);
        });
        this.isDeviceOnline = true;
        // watch network for a disconnect
        this.network.onDisconnect().subscribe(function () {
