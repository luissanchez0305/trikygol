...
export class MyApp {
  ...
  constructor(platform: Platform, statusBar: StatusBar, public helper : HelperService, public events : Events, splashScreen: SplashScreen) {
    platform.ready().then(() => {
    ...
    this.pages = [
      { title: 'HOME', component: TabsPage, type: 'root', icon: 'home' },
